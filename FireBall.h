/**
 * The FireBall class includes all the functionalities for shooting and moving the fireball. 
 * The each FireBall object has a x, y, z position, a size, an original size, 2 angles, a texture, a fire list
 * a state, a move angle and an owner of the Mover class (so either guard or hunter). The FireBall object
 * is used in the fire and process_fireball functions of the guard and the hunter.  
 * 
 */
