/**
 * The Environment class is the parent class of the Labyrinthe class that provides
 * basic functionalities like setting width and height, setting/getting data, setting the wall texture
 * and making fireballs. The file also includes the structs for Wall and Box objects and the Mover class
 * which are all objects needed for the initialization of the map.  Additionally, the word EMPTY is defined 
 * to be 0. This is also needed for the move functions of guards and the hunter. The message function, which
 * allows us to display messages to the user on screen is also defined in this file
 * 
 * 
 */
