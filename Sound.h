...
class Sound {
	char filename [256];		// nom du fichier contenant le son � jouer.
	int	error;					// core d'erreur de 'system', non utilis�.
public:
...
#ifdef __APPLE__
		sprintf (cmd, "afplay -v %g %s &", volume*5, filename);	// 5 semble �tre la valeur maximale.
#else
